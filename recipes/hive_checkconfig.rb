...
if (node['hive'].has_key? 'hive_site' && node['hive']['hive_site'].has_key? 'hive.support.concurrency' &&
  node['hive']['hive_site']['hive.support.concurrency'] == 'true' && node['hive']['hive_site'].has_key? 'hive.zookeeper.quorum')
