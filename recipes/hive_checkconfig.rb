...
if node['hive'].key? 'hive_site' and node['hive']['hive_site'].key? 'hive.support.concurrency' &&
  node['hive']['hive_site']['hive.support.concurrency'].to_b == true and node['hive']['hive_site'].key? 'hive.zookeeper.quorum'
