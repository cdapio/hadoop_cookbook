...
fs_checkpoint_dirs =
  if (node['hadoop'].has_key? 'hdfs_site' && node['hadoop']['hdfs_site'].has_key? 'dfs.namenode.checkpoint.dir')
    node['hadoop']['hdfs_site']['dfs.namenode.checkpoint.dir']
  elsif (node['hadoop'].has_key? 'hdfs_site' && node['hadoop']['hdfs_site'].has_key? 'fs.checkpoint.dir')
...
fs_checkpoint_edits_dirs =
  if (node['hadoop'].has_key? 'hdfs_site' && node['hadoop']['hdfs_site'].has_key? 'dfs.namenode.checkpoint.edits.dir')
    node['hadoop']['hdfs_site']['dfs.namenode.checkpoint.edits.dir']
  elsif (node['hadoop'].has_key? 'hdfs_site' && node['hadoop']['hdfs_site'].has_key? 'fs.checkpoint.edits.dir')
