...
dfs_data_dirs =
  if node['hadoop'].has_key? 'hdfs_site' && node['hadoop']['hdfs_site'].has_key? 'dfs.datanode.data.dir'
    node['hadoop']['hdfs_site']['dfs.datanode.data.dir']
  elsif node['hadoop'].has_key? 'hdfs_site' && node['hadoop']['hdfs_site'].has_key? 'dfs.data.dir'
...
dfs_data_dir_perm =
  if node['hadoop'].has_key? 'hdfs_site' && node['hadoop']['hdfs_site'].has_key? 'dfs.datanode.data.dir.perm'
    node['hadoop']['hdfs_site']['dfs.datanode.data.dir.perm']
  elsif node['hadoop'].has_key? 'hdfs_site' && node['hadoop']['hdfs_site'].has_key? 'dfs.data.dir.perm'
