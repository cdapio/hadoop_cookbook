...
#   Chef::Log.warn('Cloudera provides a compatibility TaskTracker, you should consider switching to YARN (MRv2)!')
...
# else
#   Chef::Log.warn('This distribution does not support a TaskTracker, use YARN (MRv2) instead!')
# end
